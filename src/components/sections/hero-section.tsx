  ...
  return (
    <section id="start" className="section-anchor w-full px-4 pb-8 pt-4 sm:px-6">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 rounded-3xl bg-white/90 p-5 shadow-lg shadow-brotart-100 sm:gap-8 sm:p-8">
        ...
        <div className={`opacity-0 animate-fade-in-up inline-flex items-center gap-2 self-start rounded-full px-4 py-2 text-sm font-semibold shadow-md ${
          isOpen 
        ...
        {/* Primary CTAs */}
        <div className="opacity-0 animate-fade-in-up flex flex-col gap-3 sm:flex-row sm:flex-wrap" style={{ animationDelay: '200ms' }}>
          <a
        ...
        <a
          ...
          className="opacity-0 animate-fade-in-up inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg border border-green-200 bg-green-50/50 px-4 py-2.5 text-sm font-medium text-green-700 shadow-sm transition-all hover:bg-green-50 hover:border-green-300 hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-500"
...
function HeroGallery({ images }: HeroGalleryProps) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setParallaxOffset(scrollProgress * 30); // 30px max offset
    };
