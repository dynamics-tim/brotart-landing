    ...
    <section id="start" className="section-anchor w-full px-4 pb-8 pt-4 sm:px-6">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 rounded-3xl bg-white/90 p-5 shadow-lg shadow-brotart-100 sm:gap-8 sm:p-8">
        ...
        <div className="opacity-0 animate-fade-in-up flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center" style={{ animationDelay: "500ms" }}>
          ...
          <a
            href="https://www.facebook.com/profile.php?id=61587802967269"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-lg border border-blue-200 bg-blue-50/50 px-4 py-2.5 text-sm font-medium text-blue-700 shadow-sm transition-all hover:bg-blue-50 hover:border-blue-300 hover:shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
            </svg>
            <span>{hero.facebookLabel}</span>
          </a>
        </div>
